...
exports.generateQuickSummary = exports.generatePipoMessageFromSession = void 0;
const Scenario_1 = __importDefault(require("../models/Scenario"));
/**
 * Generates a friendly Pipo message from a practice session
 */
const generatePipoMessageFromSession = async (session) => {
...
exports.generatePipoMessageFromSession = generatePipoMessageFromSession;
/**
 * Generates the friendly message body
 */
const generateFriendlyMessage = (session, scenarioName) => {
 ...
 */
const generateQuickSummary = (session) => {
...
//# sourceMappingURL=pipoMessageService.js.map