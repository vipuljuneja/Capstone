...
//     // this will be our data we want show
//     const [noteCards, setNoteCards] = useState([
//         { id: "1", type: "pipo", date: "2025-10-15", title: "Title", subtitle: "Ordering food : Level 3" },
//         { id: "2", type: "self", date: "2025-10-14", title: "Title", subtitle: "Ordering food : Level 2" },
//     ]);
//     const handleSaveReflection = ({ title, description }) => {
//         const newCard = {
//             id: String(Date.now()),
//             type: activeTab,
//             date: selectedDate,
...
//         //this will show dot below the date to notify it has some card 
//         noteCards.forEach(card => {
//             marks[card.date] = { marked: true, dotColor: "#111" };
//         });

//         //this  add highlight for the selected date
//         marks[selectedDate] = {
//             ...marks[selectedDate],
//             selected: true,
...
//         return marks;
//     }, [noteCards, selectedDate]);


//     // filtering cards based on date and type 
//     const visibleCards = useMemo(
//         () => noteCards.filter(n => n.date === selectedDate && n.type === activeTab),
//         [noteCards, selectedDate, activeTab]
//     );
...
//                                 <Pressable onPress={() => setWriterOpen(true)} style={styles.addBtn}>
...
//                 </View>
//             </View>
//             {/* Full calendar display on header calendar button  */}
//             <FullCalendar
...
//                                     handleSaveReflection({ title, description });
//                                     setWriterOpen(false);
//                                 }}
//                             />
//                         </View>
